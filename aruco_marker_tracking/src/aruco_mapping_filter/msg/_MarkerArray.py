"""autogenerated by genpy from aruco_mapping_filter/MarkerArray.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','aruco_mapping_filter/Marker[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = aruco_mapping_filter.msg.Marker()
        _v7 = val1.header
        start = end
        end += 4
