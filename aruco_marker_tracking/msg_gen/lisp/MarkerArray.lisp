...
(cl:in-package aruco_mapping_filter-msg)
...
(cl:defclass <MarkerArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (markers
    :reader markers
    :initarg :markers
    :type (cl:vector aruco_mapping_filter-msg:Marker)
   :initform (cl:make-array 0 :element-type 'aruco_mapping_filter-msg:Marker :initial-element (cl:make-instance 'aruco_mapping_filter-msg:Marker))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MarkerArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MarkerArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aruco_mapping_filter-msg:<MarkerArray> is deprecated: use aruco_mapping_filter-msg:MarkerArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <MarkerArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aruco_mapping_filter-msg:header-val is deprecated.  Use aruco_mapping_filter-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'markers-val :lambda-list '(m))
(cl:defmethod markers-val ((m <MarkerArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aruco_mapping_filter-msg:markers-val is deprecated.  Use aruco_mapping_filter-msg:markers instead.")
  (markers m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MarkerArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'markers)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'aruco_mapping_filter-msg:Marker))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MarkerArray>)))
  ...
  "aruco_mapping_filter/MarkerArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MarkerArray)))
  "Returns string type for a message object of type 'MarkerArray"
  "aruco_mapping_filter/MarkerArray")
