"""autogenerated by genpy from Human_intention/MarkerArray.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import Human_intention.msg
import geometry_msgs.msg
import std_msgs.msg

class MarkerArray(genpy.Message):
  _md5sum = "9d486b76ee1f72a8b0d33e8c66a97306"
  _type = "Human_intention/MarkerArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','Human_intention/Marker[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = Human_intention.msg.Marker()
        _v7 = val1.header
        start = end
        end += 4
